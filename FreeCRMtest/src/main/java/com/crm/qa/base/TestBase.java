...
public class TestBase {
	...
	public TestBase() {
		try {
		 	prop =new Properties();
			FileInputStream ip = new FileInputStream("/Users/macmini/Documents/Selenium new/selenium script/FreeCRMtest/src/main/java/com/crm/qa/config/config.properties");
			prop.load(ip);
	...
	public static void initialization() {
		...
		if(browserName.equals("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "/Users/macmini/Documents/Selenium new/selenium script/OrangeHRM/drivers/geckodriver");
