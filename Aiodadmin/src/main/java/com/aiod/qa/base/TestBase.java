...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("/Users/macmini/Documents/Selenium new/selenium script/Aiodadmin/src/main/java/com/aiod/qa/config/config.properties");
			prop.load(ip);
